...
const HandleCountry = (event,e)=>{
          ...
          const getCitydata=Countryes.find(country =>country.id===getStateid).city;
          setCity(getCitydata);
                 ...
                 <Grid container spacing={3} justifyContent="center">     
                    <Grid item>
                       <Autocomplete
                         ...
                         renderInput={(params) => <TextField {...params} variant="outlined" label="المحافظة"  />}
                       />
                      </Grid>
                 <Grid item>
                        <Autocomplete
                        ...
                        options={City}
                         ...
                         sx={{ width: 300 }}
                         renderOption={(props,option) =><Box component="li" key={option.id} {...props}>{option.name}</Box> }
                         renderInput={(params) => <TextField {...params} variant="outlined" label="المديرية" />}
                        />
                    </Grid>
                 <Grid item  >
                    <Autocomplete
                    ...
                    <Grid item>
                       <Button variant="contained" sx={{width:"150px",marginTop:"8px"}}>بــحــث</Button>
                    </Grid>
               </Grid>
            </Paper> 
                <Grid container spacing={3} justifyContent="center" 
