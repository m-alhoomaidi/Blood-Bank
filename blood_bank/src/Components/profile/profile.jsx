...
import {Card,Box,Avatar,Grid,Typography,Button,Divider,Alert,CardHeader,TextField,Autocomplete,CircularProgress} from '@mui/material';
              ...
              <Grid item md={5} xs={8} marginTop="30px">
                ...
                <Button fullWidth variant="contained" onClick={ClickOpenFile}
                  sx={{
                    ...
                    padding: { xs: "5px" }
                  }} >تحديث صورة الملف الشخصي</Button>
                <Typography color="darkgray"
                  sx={{
                    fontSize: "12px",
                    marginRight: "20px"
                  }}>مسموح بتنسيق jpg أو png أو GIF</Typography>
              </Grid>
            </Grid>
            ...
            <Grid container spacing={3}
              ...
              <Grid item md={5} xs={10.5}>
                <Autocomplete
                  ...
                  options={TypeBlood}
                  onChange={(e, event) => { formik.setFieldValue('typeBlood', event) }}
          ...
          {displayNone || IsShown === "1" ?
            <Card sx={{ marginTop: "10px", p: 1 }}>
              ...
              <Grid container spacing={2} justifyContent="center" >
                  ...
                  <Alert
                    ...
                    severity="warning" sx={{
                      "& .css-1pxa9xg-MuiAlert-message":
                        { color: "red" }
                    }}>هل أنت متأكد من عملية الإلغاء؟ <br />سيتم تعطيل حسابك ولن تظهر بياناتك عندما يتم البحث عن متبرع</Alert>
                </Grid>
                <Grid item xs={10} md={10}>
                  <Button
                    fullWidth
                ...
                <Grid item xs={10} md={10}>
                  <ModelCancle opens={open} Hand={handleClose} displayed={setDisplayNone} IsShowning={setIsShown}/>
                </Grid>
              </Grid>
            </Card> : <CardSucces Hand={handleClose} displayed={setDisplayNone} IsShowning={setIsShown} />}
        </Grid>
